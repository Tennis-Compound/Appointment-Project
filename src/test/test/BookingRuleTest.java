...
/**
 * Extended booking rule tests covering InPersonBookingRule and FollowUpBookingRule
 * which had 0% and 23% coverage respectively.
 */
public class BookingRuleTest {
    ...
    // ── FollowUpBookingRule ───────────────────────────────────────────────────
    // Rule: duration must be <= 30 minutes
