...
/**
 * Tests for DatabaseConnection (0% covered -> target >= 80%).
 * Static utility: getConnection() returns Connection or null on failure.
 * closeConnection() closes and resets the static connection field.
 */
